...
(function(){
  ...
  function budgetPie(){
    ...
    return `<div class="pb-dashboard-budget"><div class="panel"><div class="panel-head"><div><h3>Budget Allocation Distribution</h3><div class="muted">Allocation share by category</div></div><span class="badge">${money(total)}</span></div><div class="pb-chart"><div class="pb-pie" style="background:conic-gradient(${stops.join(',')})" aria-label="Budget allocation pie chart"></div><div class="pb-legend">${Object.entries(data).map(([k,v],i)=>`<span><i class="pb-dot" style="background:${colors[i%colors.length]}"></i>${esc(k)} · ${money(v)} (${(v/total*100).toFixed(1)}%)</span>`).join('')}</div></div></div><div class="panel pb-mandatory"><div class="panel-head"><div><h3>Mandatory Barangay Budget Allocations &amp; Limits</h3></div></div><ul><li><b>20% Development Fund</b> – For priority development projects.</li><li><b>10% SK Fund</b> – Reserved for youth programs and activities.</li><li><b>5% DRRM/Calamity Fund</b> – For disaster preparedness and emergencies.</li><li><b>55% Personnel Services Cap</b> – Maximum share for salaries, honoraria, and other personnel costs.</li><li><b>Other Statutory Programs</b> – Includes <b>GAD (5%)</b>, <b>LCPC (1%)</b>, and <b>Senior Citizens/PWDs (1%)</b>.</li></ul></div></div>`;
  }
